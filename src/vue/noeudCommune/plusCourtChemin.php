...
<div class="pcc-container">
    ...
    <div class="pcc-resultat">
        ...
        <div class="resultat">
            <?php if (!empty($_POST)) { ?>
                <p>
                    Le trajet entre <?= $nomCommuneDepart ?> et <?= $nomCommuneArrivee ?> fait <?= $distance ?>km. <?php if(App\PlusCourtChemin\Modele\HTTP\Cookie::existeCle("temps_calcul")) echo("<br/>Le temps de calcul à pris " . App\PlusCourtChemin\Modele\HTTP\Cookie::lire("temps_calcul") . " secondes.") ?>
                </p>
            <?php } ?>
        </div>
    </div>
